<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CanceledServices.aspx.cs" Inherits="CarWashManager.CanceledServices" %>
...
<body>
    ...
    <br />
    <center>
        <asp:Label ID="Label1" runat="server" Text="Последние 1000 отменённых заданий в порядке убывания по дате" Font-Size = "X-Large"></asp:Label>
        </center>
    <br />
    <br />
    <asp:GridView ID="GridView1" runat="server" 
         ...
         BorderStyle="Solid" BorderColor = "Black" Width = "100%"
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="Услуга" />
