<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="CarWashManager._Default"  Culture = "ru-RU" UICulture="ru-RU"%>
...
<body>
    ...
    <div style = "margin:0 auto; width:100%;height:100%">
        <CR:CrystalReportViewer ID="RepViewer" runat="server" AutoDataBind="true" 
            ...
            HasToggleGroupTreeButton="False" HasViewList="False"   p
