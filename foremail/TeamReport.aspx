<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeamReport.aspx.cs" Inherits="CarWashManager.TeamReport" Culture = "ru-RU" UICulture="ru-RU" %>
...
<body>
    ...
    <asp:Label ID="Label1" runat="server" Text="Отчет по бригадам" Font-Size ="X-Large" ></asp:Label>
        ...
        <tr>
            <td>
                <asp:CheckBox ID="chbShortReport" runat="server" Text = "Краткая форма отчета"  Font-Size ="X-Large"/> 
            </td>
        </tr>
        <tr>
            <td>
